...
% v1: apply basic WSLS model to single-subject bandit
...
modelName = 'banditWSLS_1';

% parameters to monitor
params = {'alpha', 'yPostpred'};
...
% labels
xlabel('Win-Stay Lose-Shift Probability', 'fontsize', fontSize+4);

% draw posterior densities
    density = histcounts(chains.alpha(:), ...
        'binlimits'     , [0 1]    , ...
        'binwidth'      , binWidth , ...
        'normalization' , 'pdf'    );
