%% Cricket Rasch
% v4: product space comparison of opt in models
...
generator = @()struct('theta', rand(d.nPeople, 1));
...
xTickLabel = generateTickLabel(d.nPeople, highlight);
set(gca, ...
    'units'      , 'normalized'          , ...
    'position'   , [0.125 0.925 0.8 0.05] , ...
...
% mixture posterior
bar(1:d.nPeople, zMean, 0.8, ...
    'facecolor' , pantone.DuskBlue , ...
    'edgecolor' , 'none'           );
for idx = 1:length(highlight)
 bar(highlight(idx), zMean(highlight(idx)), 0.8, ...
    'facecolor' , pantone.DuskBlue , ...
    'edgecolor' , 'k'              );
